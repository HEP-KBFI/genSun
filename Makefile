...
CFLAGS= -std=c++11 -stdlib=libc++ $(ROOTFLAGS) -funsigned-char -mmacosx-version-min=10.8 -keep_private_externs -arch x86_64 -O2 -pedantic -W -Wall -I$(PYTHIA8LOCATION)/$(INCDIR) -I/Users/joosep/Documents/gsl
